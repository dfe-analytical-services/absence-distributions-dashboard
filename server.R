    ...
    filtered_data <- df_absence %>%
      ...
      mutate(
        percent_band = case_when(
          percent_band %in% c("pct5_OARate") ~ "0-4.99%",
          ...
          percent_band %in% c("pct55_OARate") ~ "50-55%",
          percent_band %in% c("pct60_OARate") ~ "55-60%",
          percent_band %in% c("pct65_OARate") ~ "60-65%",
          percent_band %in% c("pct70_OARate") ~ "65-70%",
          percent_band %in% c("pct75_OARate") ~ "70-75%",
          percent_band %in% c("pct80_OARate") ~ "75-80%",
          percent_band %in% c("pct85_OARate") ~ "80-85%",
          percent_band %in% c("pct90_OARate") ~ "85-90%",
          percent_band %in% c("pct95_OARate") ~ "90-95%",
          percent_band %in% c("pct99_OARate") ~ "95-99.9%",
          percent_band %in% c("pct100_OARate") ~ "100%",
