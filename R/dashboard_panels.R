    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          tags$ul(
            tags$li("0 - 5%: Pupils whose overall absence was in the range 0.00 to 4.99%,"),
            tags$li("5 - 10%: Pupils whose overall absence was in the range 5.00 to 9.99%,"),
            tags$li("10 - 15%: Pupils whose overall absence was in the range 10.00 to 14.99%,"),
            tags$li("15 - 20%: Pupils whose overall absence was in the range 15.00 to 19.99%,"),
            tags$li("20 - 25%: Pupils whose overall absence was in the range 20.00 to 24.99%,"),
            tags$li("25 - 30%: Pupils whose overall absence was in the range 25.00 to 29.99%,"),
            tags$li("30 - 25%: Pupils whose overall absence was in the range 30.00 to 34.99%,"),
          ...
          card(
            ...
            card_body(
              ...
              tags$ul(
                ...
                tags$li(
                  external_link(
                    href = "https://explore-education-statistics.service.gov.uk/find-statistics/pupil-absence-in-schools-in-england/2022-23-autumn-and-spring-term",
                    "Pupil absence in schools in England: autumn and spring terms"
                  )
                ),
                tags$li(
                  external_link(
                    href = "https://explore-education-statistics.service.gov.uk/find-statistics/pupil-absence-in-schools-in-england-autumn-term/2021-22-autumn-term",
                ...
                tags$li(
                  external_link(
                    ...
                    "Pupil attendance in schools in England: Pupil attendance and absence data including termly national statistics and fortnightly experimental statistics derived from DfE’s regular attendance data"
                  )
                )
              )
            )
