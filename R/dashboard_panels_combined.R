            ...
            div(
              ...
              div(
                ...
                tags$div(
                  ...
                  br(),
                  p("The distributions may be broken down to show numbers and proportions for pupil enrolments grouped by their Free School Meal status and by sex."),
                  br(),
                      ...
                      column(
                        ...
                        conditionalPanel(
                          ...
                          selectizeInput(
                            ...
                            width = "100%",
                            multiple = TRUE
              #              >>>>>>> 2d6c8fdd882505f0b0faed63c45d868ac68195e0
                          )
                        )
                      )
                    ),
